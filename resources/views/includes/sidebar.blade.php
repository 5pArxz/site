			...
			<div class="row">
				<div class="col-xs-10  col-xs-offset-1">
					...
					<div class="widget-featured-post  push-down-30">
						...
						<p>Why ProteusThemes products is so much better than lorem everyone else's.</p>
					</div>
					<!-- Widget posts -->
					<div class="widget-posts  push-down-30">
						...
						<ul class="nav  nav-tabs">
							<li class="active">
								<a href="#recent-posts" data-toggle="tab"> <span class="fa  fa-time"></span> &nbsp;Recent Posts </a>
							</li>
							<li> <a href="#popular-posts" data-toggle="tab"> <span class="fa  fa-flash"></span> &nbsp;Popular Posts </a> </li>
						</ul>
						<!-- Tab panes -->
